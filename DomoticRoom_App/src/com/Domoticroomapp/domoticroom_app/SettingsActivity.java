...
public class SettingsActivity extends Activity  implements InterfaceCommunication, InterfaceKeyboard{
//  private static final String TAG = "bluetooth2";
//
//
//  Handler h;
...
//    
  ...
  public void onCreate(Bundle savedInstanceState) {
	...
	//	fragmentTransaction.add(android.R.id.content, fragmentSettingsCustomize).commit();
		...
		bluetooth = new Bluetooth(this, getApplicationContext());
...
//    
  ...
  public void onResume() {
    super.onResume();
    bluetooth.BluetoothOnConnection();
